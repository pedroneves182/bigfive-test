...
export default function Questions({ setResult }) {
  ...
  function handleSubmit(e) {
    e.preventDefault();
    setResult(calculateResult(selectedChoices));
  }
  ...
  return (
    <div className="max-w-screen-lg m-auto">
      <button
        className="bg-blue-700 text-blue-50 text-lg font-semibold px-8 py-2 rounded-md"
        onClick={randomize}
      >
        RANDOM
      </button>
